...
public class GuiEditor implements IGui {
    ...
    public void onClick(Player player, ItemStack clickedItem, int clickedSlot, InventoryView inv,
        ...
        if (clickedSlot == 1 && left && !right && !shift) {
            RPGProject.getInstance().getPromptManager()
                    .runPrompt(new BasicPrompt(player, RPGProject.i18n("gui.editor.prompt.display-name")) {
                        @Override
                        public void finishPrompt() {
                            GuiEditor.this.rpg.setDisplayName(this.getResult().get(0));
                            GuiEditor.this.saveItem();
                            RPGProject.send(player,
                                    RPGProject.i18n("gui.editor.prompt.display-name-1")
        ...
        if (clickedSlot == 2) {
            if (!shift) {
                ...
                if (left && !right) {
                    ...
                    RPGProject.getInstance().getPromptManager()
                            .runPrompt(new BasicPrompt(player, RPGProject.i18n("gui.editor.prompt.add-lore")) {
                                @Override
                                public void finishPrompt() {
                                    GuiEditor.this.rpg.addDescription(this.getResult().get(0));
                                    GuiEditor.this.saveItem();
                                    RPGProject.send(player, RPGProject.i18n("gui.editor.prompt.add-lore-1")
                                            .replace("%name%", GuiEditor.this.rpg.getName())
                                            .replace("%display%", GuiEditor.this.rpg.getDisplayName())
                                            .replace("%line%",
                                                    String.valueOf(GuiEditor.this.rpg.getDescription().size() - 1))
                ...
                if (right && !left) {
                    RPGProject.getInstance().getPromptManager()
                            .runPrompt(new BasicPrompt(player, RPGProject.i18n("gui.editor.prompt.insert-lore"),
                                    RPGProject.i18n("gui.editor.prompt.insert-lore-2")) {
                                @Override
                                public void finishPrompt() {
                                    int line = Util.strToInt(this.getResult().get(0), -1);
                                    if (line < 0) {
                                        RPGProject.send(player,
                                                RPGProject.i18n("gui.editor.prompt.insert-lore-1")
                                                        .replace("%name%", GuiEditor.this.rpg.getName())
                                                        .replace("%display%", GuiEditor.this.rpg.getDisplayName())
                                    ...
                                    GuiEditor.this.saveItem();
                                    RPGProject.send(player,
                                            RPGProject.i18n("gui.editor.prompt.insert-lore-3")
                                                    .replace("%name%", GuiEditor.this.rpg.getName())
                                                    .replace("%display%", GuiEditor.this.rpg.getDisplayName())
                ...
                if (left && !right) {
                    ...
                    RPGProject.send(player,
                            RPGProject.i18n("gui.editor.del-lore-last-line")
                                    .replace("%name%", GuiEditor.this.rpg.getName())
                                    .replace("%display%", GuiEditor.this.rpg.getDisplayName())
                                    .replace("%line%", String.valueOf(line)));
                    this.updateItems(inv);
                ...
                if (right && !left) {
                    RPGProject.getInstance().getPromptManager()
                            .runPrompt(new BasicPrompt(player, RPGProject.i18n("gui.editor.prompt.del-lore")) {
                                @Override
                                public void finishPrompt() {
                                    int line = Util.strToInt(this.getResult().get(0), -1);
                                    if (line < 0) {
                                        RPGProject.send(player,
                                                RPGProject.i18n("gui.editor.prompt.del-lore-1")
                                                        .replace("%name%", GuiEditor.this.rpg.getName())
                                                        .replace("%display%", GuiEditor.this.rpg.getDisplayName())
                                                        .replace("%line%", this.getResult().get(0)));
                                        RPGProject.getInstance().getGuiManager().openGui(player,
                                    ...
                                    GuiEditor.this.saveItem();
                                    RPGProject.send(player,
                                            RPGProject.i18n("gui.editor.prompt.del-lore-2")
                                                    .replace("%name%", GuiEditor.this.rpg.getName())
                                                    .replace("%display%", GuiEditor.this.rpg.getDisplayName())
                                                    .replace("%line%", String.valueOf(line)));
                                    RPGProject.getInstance().getGuiManager().openGui(player,
        ...
        if (clickedSlot == 3 && left && !right && !shift) {
            RPGProject.getInstance().getPromptManager().runPrompt(new BasicPrompt(player,
                    RPGProject.i18n("gui.editor.prompt.set-lore"), RPGProject.i18n("gui.editor.prompt.set-lore-2")) {
                @Override
                public void finishPrompt() {
                    int line = Util.strToInt(this.getResult().get(0), -1);
                    if (line < 0) {
                        RPGProject.send(player,
                                RPGProject.i18n("gui.editor.prompt.set-lore-1")
                                        .replace("%name%", GuiEditor.this.rpg.getName())
                                        .replace("%display%", GuiEditor.this.rpg.getDisplayName())
                                        .replace("%line%", this.getResult().get(0)));
                        RPGProject.getInstance().getGuiManager().openGui(player, new GuiEditor(handlePlayer, rpg));
        ...
        if (clickedSlot == 4) {
            if (!shift) {
                ...
                if (right && !left) {
                    RPGProject.getInstance().getPromptManager()
                            .runPrompt(new BasicPrompt(player, RPGProject.i18n("gui.editor.prompt.set-damage")) {
                                @Override
                                public void finishPrompt() {
                                    GuiEditor.this.runCmd(player, "rpgitem damage " + GuiEditor.this.rpg.getName() + " "
        ...
        if (clickedSlot == 5) {
            if (!shift) {
                ...
                if (left && !right) {
                    RPGProject.getInstance().getPromptManager()
                            .runPrompt(new BasicPrompt(player, RPGProject.i18n("gui.editor.prompt.set-armour")) {
                                @Override
                                public void finishPrompt() {
                                    GuiEditor.this.runCmd(player, "rpgitem armour " + GuiEditor.this.rpg.getName() + " "
                                            + this.getResult().get(0));
                                    RPGProject.getInstance().getGuiManager().openGui(player,
                                            new GuiEditor(handlePlayer, rpg));
                                }
                ...
                if (right && !left) {
                    RPGProject.getInstance().getPromptManager().runPrompt(
                            new BasicPrompt(player, RPGProject.i18n("gui.editor.prompt.set-armour-expression")) {
                                @Override
                                public void finishPrompt() {
                                    GuiEditor.this.runCmd(player, "rpgitem armorExpression "
                                            + GuiEditor.this.rpg.getName() + " " + this.getResult().get(0));
                                    RPGProject.getInstance().getGuiManager().openGui(player,
                                            new GuiEditor(handlePlayer, rpg));
                                }
        ...
        if (clickedSlot == 6) {
            if (!shift) {
                ...
                if (right && !left) {
                    RPGProject.getInstance().getPromptManager()
                            .runPrompt(new BasicPrompt(player, RPGProject.i18n("gui.editor.prompt.set-material")) {
                                @Override
                                public void finishPrompt() {
                                    ...
                                    if (material == null) {
                                        RPGProject.send(player,
                                                RPGProject.i18n("gui.editor.prompt.set-material-1")
                                                        .replace("%name%", GuiEditor.this.rpg.getName())
                                                        .replace("%display%", GuiEditor.this.rpg.getDisplayName())
                                        ...
                                        GuiEditor.this.saveItem();
                                        RPGProject.send(player,
                                                RPGProject.i18n("gui.editor.prompt.set-material-2")
                                                        .replace("%name%", GuiEditor.this.rpg.getName())
                                                        .replace("%display%", GuiEditor.this.rpg.getDisplayName())
        ...
        if (clickedSlot == 10) {
            if (!shift) {
                ...
                if (right && !left) {
                    RPGProject.getInstance().getPromptManager()
                            .runPrompt(new BasicPrompt(player, RPGProject.i18n("gui.editor.prompt.set-permission")) {
                                @Override
                                public void finishPrompt() {
                                    GuiEditor.this.rpg.setPermission(this.getResult().get(0));
                                    GuiEditor.this.saveItem();
                                    RPGProject.send(player,
                                            RPGProject.i18n("gui.editor.prompt.set-permission-1")
                                                    .replace("%name%", GuiEditor.this.rpg.getName())
                                                    .replace("%display%", GuiEditor.this.rpg.getDisplayName())
        ...
        if (clickedSlot == 12) {
            if (!shift) {
                ...
                if (right && !left) {
                    ...
                    RPGProject.getInstance().getPromptManager().runPrompt(
                            new BasicPrompt(player, RPGProject.i18n("gui.editor.prompt.set-custom-model-data")) {
                                @Override
                                public void finishPrompt() {
                                    GuiEditor.this.runCmd(player, "rpgitem customModel " + GuiEditor.this.rpg.getName()
                                            + " " + this.getResult().get(0));
                                    RPGProject.getInstance().getGuiManager().openGui(player,
                                            new GuiEditor(handlePlayer, rpg));
                                }
    ...
    private Map<Integer, ItemStack> getGUIItems() {
        ...
        items.put(1,
                Util.buildItem(
                        Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.edit-display-name.material"),
                                Material.NAME_TAG),
                        RPGProject.i18n("gui.editor.items.edit-display-name.name"),
                        RPGProject.i18n_("gui.editor.items.edit-display-name.lore")));
        items.put(2,
                Util.buildItem(
                        Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.add-del-lore.material"),
                                Material.BOOK),
                        RPGProject.i18n("gui.editor.items.add-del-lore.name"),
                        RPGProject.i18n_("gui.editor.items.add-del-lore.lore")));
        items.put(3,
                Util.buildItem(
                        Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.set-lore.material"),
                                Material.BOOK),
        ...
        items.put(
                4, Util
                        .buildItem(Enums.valueOf(Material.class,
                                        RPGProject.i18n("gui.editor.items.set-damage.material"), Material.IRON_SWORD),
        ...
        items.put(7,
                Util.buildItem(Enums.valueOf(Material.class,
        ...
        items.put(9,
                Util.buildItem(
                        Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.enchant.material"),
                                Material.ENCHANTED_BOOK),
                        RPGProject.i18n("gui.editor.items.enchant.name"), this.getEnchantLore()));
        items.put(10,
                Util.buildItem(
                        Enums.valueOf(Material.class, RPGProject
        ...
        items.put(13,
                Util.buildItem(
                        Enums.valueOf(Material.class,
                                RPGProject.i18n("gui.editor.items.set-ignore-worldguard.material"), Material.BARRIER),
        ...
        items.put(14,
                Util.buildItem(
                        Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.edit-powers.material"),
                                Material.NETHER_STAR),
                        RPGProject.i18n("gui.editor.items.edit-powers.name"),
                        RPGProject.i18n_("gui.editor.items.edit-powers.lore")));
        items.put(15,
                Util.buildItem(
                        Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.edit-item-flag.material"),
                                Material.PAPER),
    ...
    private List<String> getEnchantLore() {
        ...
        for (String s : RPGProject.i18n_("gui.editor.items.enchant.lore")) {
            s = s.replace("%mode%", RPGProject
                    .i18n("gui.editor.items.enchant.modes." + this.rpg.getEnchantMode().name().toUpperCase()));
            ...
            if (s.contains("%enchants%")) {
                if (this.rpg.getEnchantMap() != null && !this.rpg.getEnchantMap().isEmpty()) {
                    for (Enchantment ench : this.rpg.getEnchantMap().keySet()) {
                        result.add(s.replace("%enchants%", Util.getEnchName(ench) + " "
                                + Util.getRomanNumber(this.rpg.getEnchantMap().get(ench))));
                    }
                    continue;
                }
            }
