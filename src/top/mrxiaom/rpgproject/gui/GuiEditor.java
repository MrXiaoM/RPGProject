...
public class GuiEditor implements IGui {
		...
		if(clickedSlot == 1 && left && !right && !shift) {
			PromptRegistry.registerPrompt(new PlayerPrompt(player, RPGProject.i18n("gui.editor.prompt.display-name")) {
				...
				public void run() {
			    	...
			    	Util.openGuiSync(player, GuiEditor.this);
			    }
			});
			this.remove = true;
			player.closeInventory();
	...
	private Map<Integer, ItemStack> getGUIItems() {
		...
		items.put(7, Util.buildItem(Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.change-damage-mode.material"), Material.STONE_SWORD), 
				...
				RPGProject.i18n_("gui.editor.items.change-damage-mode.lore", Lists.newArrayList(
						new Pair<>("%mode%", this.rpg.getDamageMode().name().toUpperCase())
				))));
		items.put(8, Util.buildItem(Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.change-attribute-mode.material"), Material.GOLDEN_APPLE), 
				...
				RPGProject.i18n_("gui.editor.items.change-attribute-mode.lore", Lists.newArrayList(
						new Pair<>("%mode%", this.rpg.getAttributeMode().name().toUpperCase())
				))));
		items.put(9, Util.buildItem(Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.enchant.material"), Material.ENCHANTED_BOOK), 
				...
				this.getEnchantLore()));
		items.put(10, Util.buildItem(Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.set-lore-visible.material"), Material.LEVER),
		...
		items.put(11, Util.buildItem(Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.set-custom-model.material"), Material.LEATHER_CHESTPLATE),
		...
		items.put(12, Util.buildItem(Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.set-ignore-worldguard.material"), Material.BARRIER),
				...
				RPGProject.i18n_("gui.editor.items.set-ignore-worldguard.lore", Lists.newArrayList(
						new Pair<>("%switch%", this.rpg.isIgnoreWorldGuard() ? RPGProject.i18n("gui.editor.items.set-ignore-world-guard.true") : RPGProject.i18n("gui.editor.items.set-ignore-worldguard.false"))
				))));
		items.put(13, Util.buildItem(Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.edit-powers.material"), Material.NETHER_STAR), 
				RPGProject.i18n("gui.editor.items.edit-powers.name"),
				RPGProject.i18n_("gui.editor.items.edit-powers.lore")));
		items.put(14, Util.buildItem(Enums.valueOf(Material.class, RPGProject.i18n("gui.editor.items.edit-item-flag.material"), Material.PAPER),
	...
	private List<String> getEnchantLore(){
		...
		for(String s :  RPGProject.i18n_("gui.editor.items.enchant.lore")) {
			s = s.replace("%mode%", this.rpg.getEnchantMode().name().toUpperCase());
